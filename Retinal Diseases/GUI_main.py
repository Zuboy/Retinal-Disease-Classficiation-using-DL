...
root.title("Retinal Diseases Classification using Deep Learning")
...
#
label_l1 = tk.Label(root, text="Retinal Diseases Classification using Deep Learning",font=("Times New Roman", 30, 'bold'),
