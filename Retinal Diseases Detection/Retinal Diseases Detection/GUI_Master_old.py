...
#
lbl = tk.Label(root, text="Retinal disease classification using deep learning", font=('times', 35,' bold '), height=1, width=60,bg="maroon",fg="white")
lbl.place(x=0, y=3)
...
#    global fn
    ...
    if fn!="":
        ...
        if plant == 0:
            ...
            Cd="High Myopia Detected\n Avoiding potentially hazardous situations and \n Wearing protective eyewear like goggles"
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='F:/protech solutions 2023/23CP145-Myopia Detection/Pathological Myopia Diseases Detection/test_set', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
